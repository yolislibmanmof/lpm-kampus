    ...
    <div class="container pf-body">
        ...
        <div class="pf-news">
            ...
            <form class="pf-news-form" id="pfNewsForm" 
                  data-success="<?= Security::e(t('footer_newsletter_success')) ?>"
                  data-btn-text="<?= Security::e(t('footer_newsletter_btn')) ?>">
                <input type="email" placeholder="<?= t('footer_newsletter_placeholder', 'email@kampus.ac.id') ?>" required>
        ...
        <div class="pf-grid">
            ...
            <div class="pf-col">
                <?= Site::brand('footer') ?>
                <p class="pf-desc"><?= t('footer_about_desc') ?></p>
                <div class="pf-social">
            ...
            <!-- 🌐 LANG: Navigation column -->
            <div class="pf-col">
                <h4><?= t('footer_nav_title') ?></h4>
                <ul>
                    <li><a href="/index.php"><?= t('footer_nav_home') ?></a></li>
                    <li><a href="/publik/profil.php"><?= t('footer_nav_profile') ?></a></li>
                    <li><a href="/publik/akreditasi.php"><?= t('footer_nav_accreditation') ?></a></li>
                    <li><a href="/publik/dokumen.php"><?= t('footer_nav_documents') ?></a></li>
                    <li><a href="/publik/berita.php"><?= t('footer_nav_news') ?></a></li>
                </ul>
            </div>

            <!-- 🌐 LANG: Services column -->
            <div class="pf-col">
                <h4><?= t('footer_services_title') ?></h4>
                <ul>
                    <li><a href="/login.php"><?= t('footer_services_portal') ?></a></li>
                    <li><a href="/publik/pengaduan.php"><?= t('footer_services_complaint') ?></a></li>
                    <li><a href="/publik/dokumen.php"><?= t('footer_services_forms') ?></a></li>
                    <li><a href="/publik/berita.php?kategori=Agenda"><?= t('footer_services_ami') ?></a></li>
                    <li><a href="/publik/tracer.php"><?= t('footer_services_tracer') ?></a></li>
                    <li><a href="/publik/registrasi-wawancara.php"><?= t('footer_services_respondent') ?></a></li>
                    <li><a href="/publik/survei-pengguna.php"><?= t('footer_services_survey') ?></a></li>
                </ul>
            </div>
            ...
            <div class="pf-col">
                ...
                <ul class="pf-contact">
                    <li><span class="ic">📍</span><span><?= t('footer_contact_address') ?></span></li>
                    <li><span class="ic">📧</span><span>lpm@kampus.ac.id</span></li>
                    <li><span class="ic">📞</span><span>(0382) 123-4567</span></li>
                    <li><span class="ic">🕐</span><span><?= t('footer_contact_hours') ?></span></li>
                </ul>
            </div>
        </div>
        ...
        <!-- 🌐 LANG: Bottom bar -->
        <div class="pf-bottom">
            <span>© <?= date('Y') ?> <b>LPM Kampus</b>. <?= t('footer_bottom_copyright') ?></span>
            <div class="pf-bottom-links">
                <a href="/publik/profil.php"><?= t('footer_bottom_about') ?></a>
                <a href="/publik/dokumen.php"><?= t('footer_bottom_privacy') ?></a>
                <a href="/sim/index.php">SIM-Mutu</a>
            </div>
            <span><?= t('footer_bottom_system') ?> • <b>PPEPP</b></span>
        </div>
    </div>
</footer>
...
(function () {
    ...
    if (!f) return;
    var successText = f.dataset.success;
    var btnText = f.dataset.btnText;
